...
#         python er_main.py --method rand_replay --lr 0.1 --samples_per_task -1 --data_path ../Dataset/CIFAR10/ --dataset split_cifar10 --n_runs $runs --disc_iters $n_iters --mem_size $mem --suffix 'ER'
#     done
