...
ROT="--n_layers 2 --n_hiddens 100 --data_path ../Dataset/RMNIST/ --save_path results/ --batch_size 128 --log_every 100 --samples_per_task 1000 --data_file mnist_rotations.pt    --cuda yes  --seed"
